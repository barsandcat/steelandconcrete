	...
	mSheetFromFile(NULL)
{
	...
	else
	{
		...
		Root::getSingleton().setDefaultColor(Ogre::ColourValue::Black);
		...
		Root::getSingleton().setDefaultColor(Ogre::ColourValue::White);
		...
		m3->createTextItem();
		m3->setTextColor(Ogre::ColourValue::Green);
