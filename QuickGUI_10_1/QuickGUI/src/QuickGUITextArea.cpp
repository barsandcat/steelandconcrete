...
namespace QuickGUI
{
	...
	Ogre::ColourValue TextArea::getDefaultColor()
	{
	...
	void TextArea::setTextColor(const Ogre::ColourValue& cv)
	{
		mDesc->textarea_defaultColor = cv;
	...
	void TextArea::setTextColor(const Ogre::ColourValue& cv, unsigned int index)
	{
	...
	void TextArea::setTextColor(const Ogre::ColourValue& cv, unsigned int startIndex, unsigned int endIndex)
	{
	...
	void TextArea::setTextColor(const Ogre::ColourValue& cv, Ogre::UTFString::code_point c, bool allOccurrences)
	{
	...
	void TextArea::setTextColor(const Ogre::ColourValue& cv, Ogre::UTFString s, bool allOccurrences)
	{
