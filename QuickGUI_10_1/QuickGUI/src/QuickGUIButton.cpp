...
namespace QuickGUI
{
	...
	void Button::setText(Ogre::UTFString s, Ogre::FontPtr fp, const Ogre::ColourValue& cv)
	{
	...
	void Button::setText(Ogre::UTFString s, const Ogre::String& fontName, const Ogre::ColourValue& cv)
	{
		mText->setAllottedWidth(mClientDimensions.size.width);
