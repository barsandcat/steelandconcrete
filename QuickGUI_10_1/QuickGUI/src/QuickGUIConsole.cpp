...
namespace QuickGUI
{
	...
	void Console::addDisplayAreaText(Ogre::UTFString s, Ogre::FontPtr fp, const Ogre::ColourValue& cv)
	{
		mDisplayArea->addText(s,fp,cv);
	}

	void Console::addDisplayAreaText(Ogre::UTFString s, const Ogre::String& fontName, const Ogre::ColourValue& cv)
	{
